...
after brufforin the direcotyr with gobuster 
```bash
...
╭─kali@kali ~ 
```
we get http://10.129.229.147/monitoring/ accing it shwo su a login panel look like an admin login 
let make brutforing on it .
###### pass brut
```bash
